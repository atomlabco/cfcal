...
var GcalEventSource = /** @class */ (function (_super) {
    ...
    GcalEventSource.prototype.buildRequestParams = function (start, end, timezone) {
        ...
        var accessToken = this.googleCalendarAccessToken;
        var params;
        if (!apiKey && !accessToken) {
          this.reportError('Specify a googleCalendarApiKey or googleCalendarAccessToken. See http://fullcalendar.io/docs/google_calendar/');
            return null;
        }
        ...
        else if ((apiKey && accessToken) || (!apiKey && accessToken)) {
          params = $.extend(this.ajaxSettings.data || {}, {
